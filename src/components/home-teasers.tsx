          ...
          <div className="flex-1 relative w-full aspect-[4/5] md:aspect-square lg:aspect-[4/5]">
            ...
            >
              <div className="flex flex-col gap-1">
                <span className="text-3xl font-heading font-black text-brand-blue">99%</span>
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-8 left-8 right-8">
        <div className="flex flex-col gap-1">
          {prop.financing_available && (
             <div className="flex items-center gap-1 mb-2">
                <div className="px-2 py-0.5 bg-brand-blue/20 backdrop-blur-md border border-brand-blue/30 text-brand-blue text-[7px] font-black uppercase tracking-wider rounded">
                   {prop.financing_down_payment_pct ?? 20}% Financing Available
                </div>
             </div>
          )}
