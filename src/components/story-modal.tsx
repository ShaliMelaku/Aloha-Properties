              ...
              <div className="max-w-3xl space-y-24">
                ...
                <section>
                  ...
                  <p className="text-lg md:text-xl text-[var(--foreground)]/70 font-medium leading-relaxed mb-6">
                    Established in 2024, Aloha Properties was born from a singular observation: Addis Ababa&apos;s skyline was evolving faster than its marketing standards. While world-class developments were rising, the narrative around them remained transactional and static.
                  </p>
                ...
                <section className="bg-white dark:bg-luxury-charcoal p-8 md:p-12 rounded-[2.5rem] border border-[var(--border)] shadow-xl relative overflow-hidden">
                  <div className="flex flex-col md:flex-row gap-12 items-center">
                    ...
                    <div className="w-full md:w-1/2">
                      ...
                      <h5 className="text-3xl font-heading font-black tracking-tight mb-6 text-[var(--foreground)]">Mr Asmelash G/her</h5>
