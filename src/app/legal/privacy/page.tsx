    ...
    <main className="min-h-screen pt-32 pb-24 px-6 max-w-4xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
        ...
        <div className="prose prose-invert max-w-none space-y-6 opacity-80 leading-relaxed">
          ...
          <p>We leverage industry-standard security protocols, including secure database hosting, to ensure your information is protected against unauthorized access.</p>
