...
CREATE TABLE IF NOT EXISTS public.leads (
  ...
  interest TEXT,
  message TEXT,
  notes TEXT, -- Admin interaction notes
...
CREATE TABLE IF NOT EXISTS public.posts (
  ...
  type TEXT DEFAULT 'article', -- 'article', 'report', 'guide'
...
CREATE POLICY "Allow direct read access to properties" ON public.properties FOR SELECT USING (true);
CREATE POLICY "Allow direct read access to units" ON public.property_units FOR SELECT USING (true);
CREATE POLICY "Allow direct read access to progress" ON public.property_progress FOR SELECT USING (true);
CREATE POLICY "Allow direct read access to posts" ON public.posts FOR SELECT USING (true);
